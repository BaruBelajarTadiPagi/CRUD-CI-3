                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
										<a href="<?= base_url('wifiController/tambah') ?>" class="btn btn-primary mb-2">Tambah Wifi</a>
														...
														if( ! empty($wifi)) 
														{
															foreach($wifi as $data)
															{
																...
																<tr>
																	...
																	<td>".$data->wifi_password."</td>
																	<td>
																		<a href='".base_url("wifiController/ubah/".$data->id)."' class='btn btn-warning'>Ubah</a>
																		<a href='".base_url("wifiController/hapus/".$data->id)."' class='btn btn-danger' onClick='return confirm(\"Apakah Anda yakin ingin menghapus data ini?\")'>Hapus</a>
																</tr>";
															}
														}else 
														{
