                                    ...
                                    <div class="card-body">
										...
										<div class="row">
											<div class="col-lg-6 mb-2">
												...
												<input type="text" id="ip_address_device" name="ip_address_device" class="form-control" value="<?= set_value('ip_address_device') ?>">
											</div>
											<div class="col-lg-6 mb-2">
												<label for="gateway" class="form-label">Gateway</label>
												<input type="text" id="gateway" name="gateway" class="form-control" value="<?= set_value('gateway') ?>">
											</div>
											<div class="col-lg-6 mb-2">
												<label for="dns" class="form-label">DNS</label>
												<input type="text" id="dns" name="dns" class="form-control" value="<?= set_value('dns') ?>">
											</div>
										</div>
										<div class="text-end">
