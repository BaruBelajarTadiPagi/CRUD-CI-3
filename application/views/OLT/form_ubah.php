                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
										<a href="<?= base_url('oLTController') ?>" class="btn btn-primary mb-2">Kembali</a>
											<hr>

										<div class="row">
											<div class="col-lg-6 mb-1">
												<label for="description" class="form-label">Description</label>
												<input type="text" id="description" name="description" class="form-control" value="<?= set_value('description', $olt->description) ?>">
											</div>
											<div class="col-lg-6 mb-1">
												<label for="grup" class="form-label">Grup</label>
												<input type="text" id="grup" name="grup" class="form-control" value="<?= set_value('grup', $olt->grup) ?>">
											</div>
										</div>
										<div class="row">
											<div class="col-lg-6 mb-1">
												<label for="model" class="form-label">Model</label>
												<input type="text" id="model" name="model" class="form-control" value="<?= set_value('model', $olt->model) ?>">
											</div>
											<div class="col-lg-6 mb-1">
												<label for="ip_address" class="form-label">IP Address</label>
												<input type="text" id="ip_address" name="ip_address" class="form-control" value="<?= set_value('ip_address', $olt->ip_address) ?>">
											</div>
										</div>
										<div class="col-lg-12 mb-1">
											<label for="vendor" class="form-label">Vendor</label>
											<input type="text" id="vendor" name="vendor" class="form-control" value="<?= set_value('vendor', $olt->vendor) ?>">
										</div>
										<div class="col-lg-12 mb-1">
											<label for="firmware" class="form-label">Firmware</label>
											<input type="text" id="firmware" name="firmware" class="form-control" value="<?= set_value('firmware', $olt->firmware) ?>">
										</div>
										<div class="col-lg-12 mb-1">
											<label for="status" class="form-label">Status</label>
											<br>
											<input class="m-1" type="radio" name="status" value="Online" <?php echo set_radio('status','Online', ($olt->status == 'Online')); ?>>Online
											<input class="m-1" type="radio" name="status" value="Offline" <?php echo set_radio('status','Offline', ($olt->status == 'Offline')); ?>>Offline
										</div>
										<div class="text-end">
											<input type="submit" name="submit" value="Simpan" class="btn btn-info">
											<a href="<?php echo base_url('oLTController'); ?>" class="btn btn-danger">Batal</a>
										</div>
										<?php echo form_close(); ?>
                                    </div>
                                </div>
