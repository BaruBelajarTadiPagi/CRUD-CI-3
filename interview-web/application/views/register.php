                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6 col-xl-4">
                        <div class="text-center">
                            <a href="index.html">
                                <img src="<?= base_url('assets/images/logo-dark.png') ?>" alt="" height="22" class="mx-auto">
                            </a>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-4">
								...
								<div class="mb-3">
									...
									<input class="form-control" name="username" type="text" id="fullname" placeholder="Enter your name">
								</div>
								<div class="mb-3">
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <p class="text-muted">Already have account?  <a href="<?= base_url('loginController/login') ?>" class="text-dark ms-1"><b>Sign In</b></a></p>
                            </div> <!-- end col -->
                        </div>
                        <!-- end row -->
