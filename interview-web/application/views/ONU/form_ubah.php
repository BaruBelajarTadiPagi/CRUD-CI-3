                                    ...
                                    <div class="card-body">
										...
										<div class="row">
											<div class="col-lg-6 mb-1">
												...
												<input type="text" id="name" name="name" class="form-control" value="<?= set_value('name', $onu->name) ?>">
											</div>
											<div class="col-lg-6 mb-1">
												<label for="description" class="form-label">Description</label>
												<input type="text" id="description" name="description" class="form-control" value="<?= set_value('description', $onu->description) ?>">
											</div>
										</div>
										<div class="row">
											<div class="col-lg-4 mb-1">
												<label for="pon_number" class="form-label">PON number</label>
												<input type="text" id="pon_number" name="pon_number" class="form-control" value="<?= set_value('pon_number', $onu->pon_number) ?>">
											</div>
											<div class="col-lg-4 mb-1">
												<label for="sn" class="form-label">Serial Number (SN)</label>
												<input type="text" id="sn" name="sn" class="form-control" value="<?= set_value('sn', $onu->sn) ?>">
											</div>
											<div class="col-lg-4 mb-1">
												<label for="mac" class="form-label">MAC</label>
												<input type="text" id="mac" name="mac" class="form-control" value="<?= set_value('mac', $onu->mac) ?>">
											</div>
										</div>
										<div class="col-lg-12 mb-1">
											<label for="vendor" class="form-label">Vendor</label>
											<input type="text" id="vendor" name="vendor" class="form-control" value="<?= set_value('vendor', $onu->vendor) ?>">
										</div>
										<div class="row">
											<div class="col-lg-6 mb-1">
												<label for="rx" class="form-label">Received Transaction</label>
												<input type="text" id="rx" name="rx" class="form-control" value="<?= set_value('rx', $onu->rx) ?>">
											</div>
											<div class="col-lg-6 mb-1">
												<label for="tx" class="form-label">Transmitted Transaction</label>
												<input type="text" id="tx" name="tx" class="form-control" value="<?= set_value('tx', $onu->tx) ?>">
											</div>
										</div>
										<div class="row">
											<div class="col-lg-4 mb-1">
												...
												<select type="option" id="id_network" name="id_network" class="form-select" >
													...
													<?php foreach ($networks as $network): ?>
														<option value="<?= $network->id ?>"
															<?= ($network->id == $onu->id_network) ? 'selected' : '' ?>>
															<?= $network->ip_address_device ?>
														</option>
													<?php endforeach; ?>
												</select>
											</div>
										...
										<div class="row">
											<div class="col-lg-6 mb-1">
												...
												<br>
												<input class="m-1" type="radio" name="status_tr" value="Online" <?php echo set_radio('status_tr','Online', ($onu->status_tr == 'Online')); ?>>Online
												<input class="m-1" type="radio" name="status_tr" value="Offline" <?php echo set_radio('status_tr','Offline', ($onu->status_tr == 'Offline')); ?>>Offline
											</div>
											<div class="col-lg-6 mb-1">
												<label for="status_omci" class="form-label">Status OMCI</label>
												<br>
												<input class="m-1" type="radio" name="status_omci" value="Online" <?php echo set_radio('status_omci','Online', ($onu->status_omci == 'Online')); ?>>Online
												<input class="m-1" type="radio" name="status_omci" value="Offline" <?php echo set_radio('status_omci','Offline', ($onu->status_omci == 'Offline')); ?>>Offline
											</div>
										</div>
										<div class="text-end">
