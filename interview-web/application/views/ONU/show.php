                    ...
                    <div class="container-fluid">
						...
						<div class="row">
							<div class="card col-md-4 p-2">
								...
								<div class="card-body">
									Ip : <?= $onus->ip_address_device ?? '-' ?>
									<br>
									Gateway : <?= $onus->gateway ?? '-' ?>
									<br>
									DNS : <?= $onus->dns ?? '-' ?>
								</div>
							</div>
							...
							<div class="card col-md-4 p-2">
								...
								<div class="card-body">
									Wifi Name 		:  <?= $onus->wifi_name ?? '-' ?>
									<br>
									Wifi Password 	: <?= $onus->wifi_password?? '-' ?>
								</div>
							</div>

							<div class="card col-md-4 p-2">
								<div class="card-header bg-info">
									<h3>Peformance Network</h3>
								</div>
								<div class="card-body">
									RX 	: <?= $onus->rx ?? '-' ?> dBm
									<br>
										...
										<table class="table table-bordered mb-0">
											...
											<tbody>
												<tr>
													<?php
														// LOGIC STATUS TR
														if (strtolower($onus->status_tr) == 'online') {
															$status_trs = "
														...
														// LOGIC STATUS OMCI
														if (strtolower($onus->status_omci) == 'online') {
															$status_omcis = "
																<span style='display:inline-block;
																			width:10px;
																			height:10px;
													...
													<td><?= $onus->sn ?><br><?= $onus->mac ?><br> <?= $onus->ip_address_device ?></td>
													<td><?= $onus->olt_group ?? '-' ?></td>
													<td><?= $onus->olt_description ?? '-' ?></td>
													<td><?= $onus->vendor ?? '-' ?> <br> <?= $onus->olt_model ?? '-' ?><br> <?= $onus->olt_firmware ?? '-' ?></td>
													<td>
														<span><?= $status_trs ?? '-' ?>TR-069 </span>
														<span><?= $status_omcis ?? '-' ?>OMCI </span>
													</td>
													<td>N/A</td>
													<td><?= $onus->rx ?? '-' ?> dBm <br> <?= $onus->tx ?? '-' ?> dBm</td>
													<td><?= $onus->updated_at ?? '-' ?></td>
												</tr>
