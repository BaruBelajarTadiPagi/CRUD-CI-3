                                ...
                                <div class="card">
                                    <div class="card-body">
										<a href="<?= base_url('oLTController') ?>" class="btn btn-primary mb-2">Kembali</a>
											<hr>
											<?php echo form_open('oLTCOntroller/tambah'); ?>
										...
										<div class="row">
											...
											<div class="col-lg-6 mb-1">
												...
												<input type="text" id="grup" name="grup" class="form-control" value="<?= set_value('grup') ?>">
											</div>
										</div>
										<div class="row">
											<div class="col-lg-6 mb-1">
												<label for="model" class="form-label">Model</label>
												<input type="text" id="model" name="model" class="form-control" value="<?= set_value('model') ?>">
											</div>
											<div class="col-lg-6 mb-1">
												<label for="ip_address" class="form-label">IP Address</label>
												<input type="text" id="ip_address" name="ip_address" class="form-control" value="<?= set_value('ip_address') ?>">
											</div>
										</div>
										...
										<div class="col-lg-12 mb-1">
											...
											<input type="text" id="firmware" name="firmware" class="form-control" value="<?= set_value('firmware') ?>">
										</div>
										<div class="col-lg-12 mb-1">
											<label for="status" class="form-label">Status</label>
											<br>
											<input class="m-1" type="radio" name="status" value="Online" <?php echo set_radio('status','Online'); ?>>Online
											<input class="m-1" type="radio" name="status" value="Offline" <?php echo set_radio('status','Offline'); ?>>Offline
										</div>
										<div class="text-end">
