                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
										<a href="<?= base_url('oLTController/tambah') ?>" class="btn btn-primary mb-2">Tambah OLT</a>
											<span class="ms-2" style="color:#00FF00;">●</span> <?= $total_online ?>
											<span class="ms-2" style="color:gray;">●</span> <?= $total_offline ?>
                                                ...
                                                <tbody>
													<?php 
														if( ! empty($olt)) 
														{
															...
															{
																// LOGIC STATUS
																if (strtolower($data->status) == 'online') {
																	$status_html = "
																...
																<tr>
																	<td>".$data->id."</td>
																	<td>".$data->description." (".$data->ip_address.")</td>
																	<td>".$data->grup."</td>
																	<td>".$data->model."</td>
																	...
																	<td>
																		<a href='".base_url("oLTController/ubah/".$data->id)."' class='btn btn-warning'>Ubah</a>
																		<a href='".base_url("oLTController/hapus/".$data->id)."' class='btn btn-danger' onClick='return confirm(\"Apakah Anda yakin ingin menghapus data ini?\")'>Hapus</a>
																</tr>";
															}
														}else 
														{
