                                ...
                                <div class="card">
                                    <div class="card-body">
										<a href="<?= base_url('wifiController') ?>" class="btn btn-primary mb-2">Kembali</a>
											...
											<?php echo form_open('wifiController/tambah'); ?>

										<div class="row">
											<div class="col-lg-6 mb-2">
												<label for="wifi_name" class="form-label">Nama Wifi</label>
												<input type="text" id="wifi_name" name="wifi_name" class="form-control" value="<?= set_value('wifi_name') ?>">
											</div>
											<div class="col-lg-6 mb-2">
												<label for="wifi_password" class="form-label">Password Wifi</label>
												<input type="text" id="wifi_password" name="wifi_password" class="form-control" value="<?= set_value('wifi_password') ?>">
											</div>
										</div>
										<div class="text-end">
