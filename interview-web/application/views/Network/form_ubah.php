                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
										<a href="<?= base_url('networkController') ?>" class="btn btn-primary mb-2">Kembali</a>
											<hr>

										<div class="row">
											<div class="col-lg-6 mb-2">
												<label for="ip_address_device" class="form-label">Nomor IP Device</label>
												<input type="text" id="ip_address_device" name="ip_address_device" class="form-control" value="<?= set_value('ip_address_device', $network->ip_address_device) ?>">
											</div>
											<div class="col-lg-6 mb-2">
												<label for="gateway" class="form-label">Gateway</label>
												<input type="text" id="gateway" name="gateway" class="form-control" value="<?= set_value('gateway', $network->gateway) ?>">
											</div>
											<div class="col-lg-6 mb-2">
												<label for="dns" class="form-label">DNS</label>
												<input type="text" id="dns" name="dns" class="form-control" value="<?= set_value('dns', $network->dns) ?>">
											</div>
										</div>
										<div class="text-end">
											<input type="submit" name="submit" value="Simpan" class="btn btn-info">
											<a href="<?php echo base_url('networkController'); ?>" class="btn btn-danger">Batal</a>
										</div>
										<?php echo form_close(); ?>
                                    </div>
                                </div>
